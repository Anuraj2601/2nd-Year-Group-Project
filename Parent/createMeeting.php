...
<html>
  ...
  <body>
    <div class="navbar">
		...
		<div class="sidebar">
			...
			<a href="createMeeting.php" class="active"><i class="fa fa-fw fa-video-camera"></i> Meeting</a>
  ...
  <script>
    ...
    function createMeeting() {
          ...
          console.log("http://"+ window.location.host + "/Group Project/Parent/?meetingId="+ meetingId)
          document.getElementById("copyInput").value = "https://"+ window.location.host + "/Group Project/Parent/meeting.html?meetingId="+ meetingId;
    }

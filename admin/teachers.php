...
<div class="navbar">
		...
		<div class="sidebar">
			...
			<a href="teachers.php"  class="active"><i class="fa fa-fw fa-users"></i> Teachers</a>
    ...
    <div class="content1">
        ...
        <div class="message-form">
          ...
          <form id="add_downloadable" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
              <div class="controls">
                <input type="text" name="language" placeholder="Language" class="input" required>
              </div>
            </div>
            ...
            <div class="control-group">
				...
				<div class="content1">
					<div class="message-form">
					<button name="Post" type="submit" class="btn btn-info">Sinhala</button>
          <button name="Post" type="submit" class="btn btn-info">Tamil</button>
          <button name="Post" type="submit" class="btn btn-info">English</button>
          <form id="add_downloadable" method="post" enctype="multipart/form-data">

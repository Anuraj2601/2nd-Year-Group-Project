				...
				<button onclick="changeLanguage('si')">Translate to sinhala</button>
					<div class="content">
                        ...
                        <?php
							...
							<form method="post">
								...
								<label class="control-label" for="fileInput">Subject Code:</label>
									<div class="controls">
										<input type="text" name="subject_code" value="<?php echo $row['subject_code']; ?>" placeholder="Subject code" class="input" required>
									</div>
								</div>
								<div class="control-group">
								<label class="control-label" for="fileInput">Subject Title:</label>
									<div class="controls">
										<input type="text" name="title" value="<?php echo $row['subject_title']; ?>" placeholder="Subject Title" class="input" required>
									</div>
								</div>
								<br>
                        ...
                        <?php
										...
										mysqli_query($link,"update subject set subject_code = '$subject_code' ,
																		subject_title = '$title',

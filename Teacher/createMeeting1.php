...
<html>
  ...
  <div class="navbar">
		...
		<div class="sidebar">
			...
			<a href="createMeeting1.php" class="active"><i class="fa fa-fw fa-video-camera"></i> Meeting</a>
  ...
  <script>
    ...
    function createMeeting() {
          ...
          console.log("http://"+ window.location.host + "/Group Project/Teacher/?meetingId="+ meetingId)
          document.getElementById("copyInput").value = "https://"+ window.location.host + "/Group Project/Teacher/meeting.php?meetingId="+ meetingId;
    }

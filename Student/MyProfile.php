					  ...
					  <div class="container1">
							...
							<form action = "Login.php" method = "post">
								...
								<div class = "cont1">
									...
									<input type="radio" name="gender" id="ip1" placeholder="" value="male">
									<label for="male" class ="text1">Male</label>
									<input type="radio" name="gender" id="ip1" placeholder="" value="female">
					...
					<div class="column1">
						<div class="container1">
                            ...
                            <div class = "cont1">
                                ...
                                <input type="number" name="user" id="ip1" placeholder="">
                            </div>

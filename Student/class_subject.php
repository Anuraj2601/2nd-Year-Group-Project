...
<head>
	...
	<body>
		...
		<div class="sidebar">
			...
			<a href="class_progress.php"><i class="fa fa-fw fa-bar-chart-o"></i>My Progress</a>
			<a href="class_subject.php" class="active"><i class="fa fa-fw fa-file-o"></i> Subject Overview</a>
  ...
  <!-- Language buttons -->
                ...
                <section class="overview">
                    <div class="instructor">
                        ...
                        <p>Name: John Doe</p>
                        <p>Email: john123@gmail.com</p>
                    </div>
                    <div class="description">
                        <h2>Course Description</h2>
                        <p>This document comprises a detailed description of the course including the introduction, time duration, number of credits allocated, evaluation criteria, learning outcomes, assessment plan, topics to be covered and the lecturer's details.</p>
                    </div>
                    <!-- Include other sections like prerequisites, learning objectives, etc. -->
                </section>
                <section class="resources">
                    <h2>Topic 1</h2>
                    <a href="example.pdf" target="_blank" title="Download PDF">Lecture 01</a>
                    <!-- Include links to resources here -->
                </section>
                <section class="resources">
                    <h2>Topic 2</h2>
                    <a href="example.pdf" target="_blank" title="Download PDF">Lecture 02</a>
                    <!-- Include links to resources here -->
                </section>
                <section class="resources">
                    <h2>Topic 3</h2>
                    <a href="example.pdf" target="_blank" title="Download PDF">Lecture 03</a>
                    <!-- Include links to resources here -->
                </section>
                <section class="resources">
                    <h2>Topic 4</h2>
                    <a href="example.pdf" target="_blank" title="Download PDF">Lecture 04</a>
                    <!-- Include links to resources here -->
                </section>
					</div>
